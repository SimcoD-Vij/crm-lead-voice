...
from api.services.pipecat.low_latency_aggregator import LowLatencyAggregator
...
async def _run_pipeline(
    ...
    if is_realtime:
        ...
        # Create low latency aggregator for adaptive chunking
        low_latency_aggregator = LowLatencyAggregator()
        ...
        pipeline = build_pipeline(
            ...
            low_latency_aggregator=low_latency_aggregator,
        )
