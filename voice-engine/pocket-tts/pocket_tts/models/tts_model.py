    ...
    def _from_pydantic_config_with_weights(
        ...
        if config.weights_path is not None:
            ...
            try:
                ...
                logger.warning(f"Failed to download {config.weights_path}, falling back to public weights.")
            ...
            # Re-enable if weights contain the key
            if "flow_lm.speaker_proj_weight" in state_dict:
